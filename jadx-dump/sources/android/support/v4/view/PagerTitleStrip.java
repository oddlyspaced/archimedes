...
public class PagerTitleStrip extends ViewGroup implements ViewPager.Decor {
    ...
    void updateText(int currentItem, PagerAdapter adapter) {
        ...
        int childWidthSpec = View.MeasureSpec.makeMeasureSpec((int) (((float) width) * 0.8f), ExploreByTouchHelper.INVALID_ID);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int childWidthSpec = View.MeasureSpec.makeMeasureSpec((int) (((float) widthSize) * 0.8f), ExploreByTouchHelper.INVALID_ID);
        int childHeightSpec = View.MeasureSpec.makeMeasureSpec(heightSize - padding, ExploreByTouchHelper.INVALID_ID);
        this.mPrevText.measure(childWidthSpec, childHeightSpec);
        this.mCurrText.measure(childWidthSpec, childHeightSpec);
        this.mNextText.measure(childWidthSpec, childHeightSpec);
